...
|:-----------:|:-----------:|:------------:|:------:|
 ...
 | approvesuggest | approve | Approve Suggestions | Admin, Broadcaster 
 ...
 | code |  | Returns a link to the current command Code on github | Developer, Moderator 
 | coinflip | cf | Just a coinflip 4Head | User 
 | color |  | Check Color of you or other users | User 
 | commands | cvmds | Shows you a list of all my commands | User 
 | content |  | Content for stream (only avalible in #florian_2807 | User 
 | denysuggest | deletesuggest | delete a suggestion | Admin, Broadcaster 
 ...
 | emotegame | emotequiz | starts an emote quiz (test) | Admin, Broadcaster 
 | emotepings | emoteping | enable to get pinged if there are new or removed emotes in the specified channel |  
 | emotes | emotes | Check Sub-Emotes of a Streamer | User 
 | emotesearch |  | searchs for emotes on all platforms | User 
 | eval | eval | Evaluates the given code | Admin, Broadcaster 
 ...
 | registeruser |  | Enable count the messages in #revedtv, #papaplatte or #ungespielt for an user | Developer, Moderator 
 | reload |  | Reload commands | Admin, Broadcaster 
 | removesuggestion |  | Remove your suggestion | User 
 | reset stats |  | Resetting Stats of Message Count | Admin, Broadcaster 
 | restart |  | Restarts the bot | Admin, Broadcaster 
 | say | echo | repeat your message | User 
 | search |  | duckduckgo search | User 
 | searchusername | su | Not available | Admin, Broadcaster 
 | setlevel |  | Set Userlevel | Admin, Broadcaster 
 | setprefix |  | Change Bot-Prefix for the targeted chat | Developer, Moderator 
 | showsuggestions |  | Returns a Hastebin link with current suggestions. | Admin, Broadcaster 
 | spam |  | spams something into the chat (max. 50) | User 
 | spotify |  | check what flo is listening :) | Admin, Broadcaster 
 | subage | sa | Check your Subage | User 
 | subemotes |  | Shows you all subemote of a streamer | Admin, Broadcaster 
 | suggest |  | Suggest something, that can help the bot :) | User 
 | test |  | Test | Admin, Broadcaster 
 ...
 | unregisteruser |  | Disable count the messages in #revedtv or #papaplatte for an User | Developer, Moderator 
 ...
 | write |  | Write a message in the targeted channel | Admin, Broadcaster 
